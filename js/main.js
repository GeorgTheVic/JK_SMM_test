...
/* harmony import */ var _components_folding__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/folding */ "./src/js/components/folding.js");
/* harmony import */ var _components_folding__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_folding__WEBPACK_IMPORTED_MODULE_1__);
...
const boxes = document.querySelectorAll('.box'),
      infos = document.querySelectorAll('.box__info');
boxes.forEach(box => {
  box.addEventListener('click', e => {
    box.classList.toggle('active');
    box.childNodes[3].classList.toggle('rotate');
    box.childNodes[5].classList.toggle('visible');
  });
});
